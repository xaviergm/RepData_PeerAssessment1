...
As mentioned before, further processing of the data will happen at a later stage. However, at this point the dates will be converted so they can be used later.
```{r}
...
In order to create the new factor variable, the functions weekdays() and 